...
public class Tela04_A3_TabbedProdutosAtendimento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelaProd.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código I", "Código II", "Nome", "Descrição", "Validade", "Categoria", "Valor", "Qtd."
            }
        ));
    ...
    private void btnPesquisarProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarProdActionPerformed
        DefaultTableMode1 modelo = (DefaultTableMode1) tabelaProd.getModel();
        modelo.setNumRows(0);
        ProdutosDao pdao = new ProdutosDao();
        for (Produtos c : dao.getContatos()) {
            modelo.addRow(new Object[]{c.getcod_prod(), c.getcod_for(), c.getdescricao(),
                c.getdata_validade(), c.getcategoria(), c.getvalor(), c.getquantidade()});
